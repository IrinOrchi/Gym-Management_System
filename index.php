...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Orchita's Gym Admin</a></h1>
</div>
<!--close-Header-part-->
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class="fa-thin fa-bangladeshi-taka-sign"></i> Total Earnings: Tk <?php include'income-count.php' ?></a> </li>
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_ly"><i class="fas fa-money-bill"></i> <strong>Tk<?php include 'actions/total-exp.php';?></strong> <small>Total Expenses</small></li>
