     ...
     <div class="widget-content">
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                  <tr>
                      <td><h4>Orchita's Gym</h4></td>
                    </tr>
                    <tr>
                      <td>Mohakhali, TB Gate</td>
                    </tr>
                    ...
                    <tr>
                      <td >Email: irin.hoque.orchi@g.bracu.ac.bd</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="row-fluid">
                ...
                <div class="pull-right">
                  ...
                  <img src="../img/report/stamp-sample1.jpg" width="124px;" alt=""><p class="text-center">Orchita's Gym</p> </div>
